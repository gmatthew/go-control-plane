...
func (m *PriorityLoadBalancer) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *PriorityLoadBalancer) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *PriorityLoadBalancer) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if msg, ok := m.ConcurrencyControllerConfig.(*PriorityLoadBalancer_GradientControllerConfig); ok {
...
func (m *PriorityLoadBalancer_GradientControllerConfig) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *PriorityLoadBalancer_GradientControllerConfig) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *PriorityLoadBalancer) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PriorityLoadBalancer_GradientControllerConfig) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
