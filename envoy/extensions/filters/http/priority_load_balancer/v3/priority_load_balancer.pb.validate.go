...
// Validate checks the field values on PriorityLoadBalancer with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *PriorityLoadBalancer) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PriorityLoadBalancer with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PriorityLoadBalancerMultiError, or nil if none found.
func (m *PriorityLoadBalancer) ValidateAll() error {
	return m.validate(true)
}

func (m *PriorityLoadBalancer) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, PriorityLoadBalancerValidationError{
					field:  "Enabled",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return PriorityLoadBalancerValidationError{
				field:  "Enabled",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	case *PriorityLoadBalancer_GradientControllerConfig:
		if v == nil {
			err := PriorityLoadBalancerValidationError{
	...
	if len(errors) > 0 {
		return PriorityLoadBalancerMultiError(errors)
	}

	return nil
}

// PriorityLoadBalancerMultiError is an error wrapping multiple validation
// errors returned by PriorityLoadBalancer.ValidateAll() if the designated
// constraints aren't met.
type PriorityLoadBalancerMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PriorityLoadBalancerMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PriorityLoadBalancerMultiError) AllErrors() []error { return m }

// PriorityLoadBalancerValidationError is the validation error returned by
// PriorityLoadBalancer.Validate if the designated constraints aren't met.
type PriorityLoadBalancerValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PriorityLoadBalancerValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PriorityLoadBalancerValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PriorityLoadBalancerValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PriorityLoadBalancerValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PriorityLoadBalancerValidationError) ErrorName() string {
	return "PriorityLoadBalancerValidationError"
}

// Error satisfies the builtin error interface
func (e PriorityLoadBalancerValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPriorityLoadBalancer.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PriorityLoadBalancerValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PriorityLoadBalancerValidationError{}
